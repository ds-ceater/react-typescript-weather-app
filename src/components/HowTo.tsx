  ...
  <div className="HowToInner">
    <div className="HowToListWrap">
      ...
      <ul className="HowToList">
        <li className="HowToItem">「都市名を調べる」の欄に天気を調べたい都市を記入して「天気を調べる」ボタンを押してください。日本語では仕様上時折不正確になるため、できれば英語、ローマ字でのご記入をおすすめします。</li>
    ...
    <div className="HowToListWrap">
      <h1 className="HowToTitle">使用技術</h1>
        ...
        <p className="HowToText">React, TypeScript, Chart.js, API, Vite, HTML, SASS</p>
